...
FONT = pygame.font.Font("images/opensans.ttf", 36)
death_sound = pygame.mixer.Sound('sounds/die-101soundboards.mp3')
jump_sound = pygame.mixer.Sound('sounds/jump-101soundboards.mp3')
point_sound = pygame.mixer.Sound('sounds/point-101soundboards.mp3')
clock = pygame.time.Clock()
FPS = 60

classroom = pygame.image.load("images/classroom.jpg")
...
mouse_rect = mouse.get_rect(center=(50, 625))
rip = pygame.image.load("images/rip.png")
rip = pygame.transform.scale(rip, (200, 200))
rip_rect = rip.get_rect(center=(650, 400))
trap = pygame.image.load("images/mousetrap.png")
